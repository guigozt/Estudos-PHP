...
<head>
    ...
    <title>Desafio 3 - Conversor de Moeda</title>
</head>

<body>
    <header><h1>Desafio 3 - Conversor de Moeda</h1></header>

    <section>
        <form action="11-Dados-desafio3.php" method="POST" onsubmit="return validateForm()">
